...
public class ServiceSourceParser implements SourceParser, VelocityEngineAware {
  ...
  public String parse(GeneratorConfig config, Table table) {
    ...
    context.put("simpleName", table.getEntityName() + "Service");
    ...
    try (InputStream input = getClass().getClassLoader().getResourceAsStream("template/Service.vm")) {
